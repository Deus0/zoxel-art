...
[Title("Zoxel", "Marzo")]
public class ZoxelMarzoNode : CodeFunctionNode
{
    public ZoxelMarzoNode()
    {
        name = "Zoxel Marzo";
    }
    ...
    protected override MethodInfo GetFunctionToConvert()
    {
        return GetType().GetMethod("ZoxelMarzo", BindingFlags.Static | BindingFlags.NonPublic);
    }

    private static string ZoxelMarzo(
        [Slot(0, Binding.WorldSpacePosition)] Vector3 WorldPosition,
        [Slot(1, Binding.WorldSpacePosition)] Vector3 Center,
        [Slot(2, Binding.None, 0.5f, 0, 0, 0)] Vector1 Radius, 
        [Slot(3, Binding.None)] out Vector1 Output)
    {
        return @"
{    
